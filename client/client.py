...
def parse_args():
    parser = argparse.ArgumentParser(description="COM-302 black-box channel simulator. (client)",
                                     ...
                                     epilog="To promote efficient communication schemes, transmissions are limited to 100 sample.")
...
if __name__ == '__main__':
    version_cl = b'dUR'  # Always length-3 alphanumeric
    ...
    if N_sample > 200:
        raise ValueError(('Parameter[input_file] contains more than 100 samples. '
